...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-07753fa2');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-07753fa2');}
...
var brandEl=document.querySelector('.rl-brand-07753fa2');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
